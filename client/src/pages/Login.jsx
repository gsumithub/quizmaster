    ...
    <div className="flex-1 flex justify-center items-center px-4 py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-8 animate-fade-in">
        ...
        <div className="glass-panel p-8 rounded-3xl shadow-2xl relative">
          ...
          {/* Quick login instruction note */}
          <div className="mt-6 pt-6 border-t border-dark-800 text-center">
            <p className="text-xs text-dark-400">
              No account? Use <span className="font-semibold text-white">Sign Up</span> page to create standard user or administrator accounts.
            </p>
          </div>
        </div>
      </div>
